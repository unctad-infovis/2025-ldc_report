    ...
    <div className="header_container">
      ...
      <div className="content_bottom">
        ...
        <div className="download_buttons_container">
          <a href="https://unctad.org/system/files/official-document/ldc2025overview_en.pdf" target="_blank" onClick={(event) => downloadDocument(event)} type="button" aria-label="Download Overview" className="overview" rel="noreferrer">Overview</a>
          <a href="https://unctad.org/system/files/official-document/ldc2025_en.pdf" target="_blank" onClick={(event) => downloadDocument(event)} type="button" aria-label="Download Full Report" className="pdf_download" rel="noreferrer">Full report</a>
